	...
	ui(new Ui::MainWindow)
{
	...
	cnv.push_back(ct::ParamsCnv(3, 64, true, 0.94));
	cnv.push_back(ct::ParamsCnv(3, 128, true, 0.94));
	cnv.push_back(ct::ParamsCnv(3, 256, false, 0.94));
	cnv.push_back(ct::ParamsCnv(3, 512, false, 0.94));
